export default function animate() {
  ...
  function b() {
    if (((l = document.getElementById('source')), l && l.getContext)) {
      k = l.getContext('2d');
  ...
  function d() {
    ...
    for (var a = 0; a < v.length; a++) {
      ...
      if (b.force > 1e-4)
        ...
        var c = 0.2 * (b.originX - b.currentX),
          e = 0.2 * (b.originY - b.currentY),
          f = 0.2 * (0 - b.rotation);
        Math.abs(c) < 0.5 ? (b.currentX = b.originX) : (b.currentX += c),
          Math.abs(e) < 0.5 ? (b.currentY = b.originY) : (b.currentY += e),
          Math.abs(f) < 0.5 ? (b.rotation = 0) : (b.rotation += f);
      } else b.force = 0;
      m.save(),
  ...
  function e() {
    for (
      var b = q + (t.width - s.width) / 2, c = r + (t.height - s.height) / 2, d = 0;
      d < s.height;
  ...
  function f(a, b) {
    ...
    e.pageX || e.pageY
      ? ((c = e.pageX), (d = e.pageY))
      : (e.clientX || e.clientY) &&
        ((c = e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft),
  ...
  function g(a) {
    var b = a.offsetTop;
    return null != a.offsetParent && (b += g(a.offsetParent)), b;
  }
  function h(a) {
    var b = a.offsetLeft;
    return null != a.offsetParent && (b += h(a.offsetParent)), b;
  }
  function i(a, b) {
    for (var c = 0; c < v.length; c++) {
      ...
      if (l > e.force) {
        ...
        (e.moveX = Math.cos(m)), (e.moveY = Math.sin(m)), (e.moveRotation = 0.5 - Math.random());
      }
    }
    v.sort(j), d();
  }
  ...
  var k,
    l,
    m,
    n = document.getElementById('sourceimg').src,
    o = 21,
    p = 15,
    q = 10.5,
    r = 7.5,
